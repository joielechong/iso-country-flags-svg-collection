...
We try to keep the TODO list short. You can [browse issues related to iso-country-flags-svg-collection](https://github.com/koppi/iso-country-flags-svg-collection/issues) to see, what's being worked on.
