...
Simply type "make" to build png versions of the country flags contained in this collection. You will end up with flat, simple, fancy, glossy template based PNG files with the following resolutions: 512x512 (web), 256x256, 128x128, 96x96, 72x72, 64x64, 48x48, 36x36, 32x32, 24x24, 16x16.

For example the result for the "United States" country flag looks like follows:
